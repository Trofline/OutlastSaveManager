namespace OutlastSaveManager
{
    partial class mods
    {
        ...
        private void InitializeComponent()
        {
            ...
            nodamageBtn = new Button();
            tptofreecamBtn = new Button();
            SuspendLayout();
            // 
            // button1
            // 
            ...
            // nodamageBtn
            // 
            nodamageBtn.Location = new Point(12, 70);
            nodamageBtn.Name = "nodamageBtn";
            nodamageBtn.Size = new Size(171, 23);
            nodamageBtn.TabIndex = 2;
            nodamageBtn.Text = "NoDamage";
            nodamageBtn.UseVisualStyleBackColor = true;
            nodamageBtn.Click += nodamageBtn_Click;
            // 
            // tptofreecamBtn
            // 
            tptofreecamBtn.Location = new Point(12, 99);
            tptofreecamBtn.Name = "tptofreecamBtn";
            tptofreecamBtn.Size = new Size(171, 23);
            tptofreecamBtn.TabIndex = 3;
            tptofreecamBtn.Text = "TP Freecam";
            tptofreecamBtn.UseVisualStyleBackColor = true;
            tptofreecamBtn.Click += tptofreecamBtn_Click;
            // 
            // mods
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(197, 251);
            Controls.Add(tptofreecamBtn);
            Controls.Add(nodamageBtn);
        ...
        private Button nodamageBtn;
        private Button tptofreecamBtn;
    }
}